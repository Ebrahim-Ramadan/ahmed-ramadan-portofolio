...
export const Share = ({props}) => {
  return (
    ...
    <g id="Iconly/Bulk/Send" stroke="none" stroke-width="1.5" fill="white" fill-rule="evenodd">
...
<svg width="60" height="60" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" >
    <g id="Iconly/Bold/Image" stroke="none" stroke-width="1.5" fill="white" fill-rule="evenodd">
        <g id="Image" transform="translate(2.000000, 2.000000)" fill="white" fill-rule="nonzero">
...
export const FB = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="white" stroke="transparent" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-facebook"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>  
    )
}
export const Gmail = () => {
  return (
    <a href="https://mail.google.com/mail/u/0/?fs=1&to=ali.elsabbagh@ejust.edu.eg&tf=cm" target='_blank'>
...
export const WhastApp = ({props}) => {
  return (
<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="25" viewBox="0 0 30 30" fill="white">
...
export const RightArrow = ({props}) => {
  return (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-move-right"><path d="M18 8L22 12L18 16"/><path d="M2 12H22"/></svg>
...
export const Behance = ({props}) => {
  return (
    <a href="https://www.behance.net/ARCHUWK/projects" target='_blank'>
