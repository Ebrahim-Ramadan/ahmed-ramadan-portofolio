  ...
  return (
    <div className="grid grid-cols-6 gap-1 items-center">
       <input
         ...
         className="h-10 backdrop-blur-md bg-white/10 font-light placeholder:text-primary-900 focus:outline-none text-sm text-slate-50 w-full col-span-5 px-4 rounded-2xl"
       />
